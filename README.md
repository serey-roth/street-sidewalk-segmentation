...
We evaluated `DeepLabV3-ResNet50` model, which is trained on COCO/Pascal VOC's 20 general object classes, against the `sidewalk-semantic` dataset labels (34 sidewalk-specific classes e.g. `flat-sidewalk`, `flat-curb`, `flat-crosswalk`).
